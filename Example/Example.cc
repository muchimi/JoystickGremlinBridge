...
void CALLBACK MyDispatchProc(SIMCONNECT_RECV* pData, DWORD cbData, void* pContext) {
  switch (pData->dwID) {
    ...
    case SIMCONNECT_RECV_ID_CLIENT_DATA: {
      ...
      if (e->dwRequestID == gremlinex::kDownlinkRequest) client->HandleReceivedClientDataEvent(e);
      break;
    }
  }
}
...
int main() {
  SimConnect_Open(&simconnect, "GremlinExBridge Consumer Example", 0, 0, 0, 0);

  // We'll use our lovely flyover sdk client.
  client = new gremlinex::Client(simconnect);
