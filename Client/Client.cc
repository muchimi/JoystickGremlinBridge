...
gremlinex::Client::Client(void* simconnect) {
...
void gremlinex::Client::HandleReceivedClientDataEvent(void* event) {
...
gremlinex::Packet* gremlinex::Client::Request(char data[], int timeout) {
...
void gremlinex::Client::ExecuteCalculatorCode(std::string code) {
  char data[gremlinex::kPacketDataSize] = {};
  data[0] = gremlinex::kExecuteCalculatorCode;
...
double gremlinex::Client::GetNamedVariable(std::string variable_name) {
  char data[gremlinex::kPacketDataSize] = {};
  data[0] = gremlinex::kGetNamedVariable;
